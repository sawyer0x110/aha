...
Start with the [Aha introduction](examples/aha-introduction/README.md): [2:35 English video](examples/aha-introduction/aha-introduction.en.mp4), [2:31 Chinese video](examples/aha-introduction/aha-introduction.zh.mp4), [bilingual HTML](examples/aha-introduction/aha-introduction.html), an [8-slide Chinese native PPTX](examples/aha-introduction/aha-introduction.pptx), or a [Chinese infographic](examples/aha-introduction/aha-introduction.png). The videos explain research methods and boundaries, media and language choices, and four real examples; they use an updated local-document research snapshot. The unchanged HTML, PPTX and PNG retain their September 17 snapshot. Explore the [Greenland](examples/greenland/README.md), [CPython strings](examples/cpython-string/README.md), and [Docker image layers](examples/docker-layers/README.md) examples separately. Topic guides record sources, editable projects, outputs, and review limits.

The [full gallery](examples/README.md) also includes noise cancellation: five topics and twenty-one artifacts in total. Aha introduction is the only project tour. Examples are snapshots, not promises about the current runtime. A successful render or short preview is not a substitute for complete visual and listening review.
