...
实际案例见 [examples](examples/README.md)：降噪耳机、Git merge 和 [Aha 项目导览](examples/project-overview/README.md)均已重新调研，分别提供双语交互 HTML、PNG、原生 PPTX 和英文配音视频，共十二份作品。每例保留匹配的研究、可编辑源、收据与音频来源；完整视频听看与附加 PPT 动画放映的未确认边界单独记录。
