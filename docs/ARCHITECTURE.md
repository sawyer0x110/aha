...
| `evals/examples/` | 示例验收工具和保留的结果；`refresh-20260916/` 是前三例记录，`greenland-20260917/` 是格陵兰记录，`code-pilots-20260917/` 保存代码试片证据，`aha-introduction-20260917/` 保存新版介绍的授权、试片确认与修正后的编码证据；旧版结果保留为历史 |
