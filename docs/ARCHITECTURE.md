...
| `evals/examples/` | 示例验收工具和保留的结果；`refresh-20260916/` 是前三例新版记录，`greenland-20260917/` 是格陵兰视频记录，旧版结果保留为历史 |
| `examples/` | 三例各四种格式，加上仅视频的格陵兰例子；保存作品、收据、`projects/<format>/` 可编辑项目、研究与音频来源；`delivery-manifest.json` 索引十三份作品的当前字节身份 |
