...
从[本地作品入口](index.html)或[新版 Aha 视频介绍](aha-introduction/README.md)开始。三个主题于 2026-09-16 分别重新调研并各创作四种格式；2026-09-17 新增格陵兰视频、CPython/Docker 两支机制试片，以及总分总结构的新版项目介绍，共七组示例、十六份作品。新旧项目介绍使用不同研究快照，分开保存，不把它们伪装成同一版四格式作品。HTML 默认英文，可切换中文；PNG、原生 PPTX 和配音视频为英文。前四例研究报告为中文，两支代码试片与新版介绍研究报告为英文。GitHub 源码预览不会执行交互页面。
