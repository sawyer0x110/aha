...
本组独立收录新版视频，保留[较早研究快照的四格式项目导览](../project-overview/README.md)。两者研究快照不同，不混成同一版四格式作品。[新版能力介绍图片](../project-overview/overview.png)已由用户选用，替换该导览的 PNG；它只介绍项目定位、两个 skills 和四种能力，不展示案例，仍绑定该导览的研究快照。
