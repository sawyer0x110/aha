...
[交互讲解](index.html)、[1800×1200 信息图](git-merge.png)、[8 页中文原生 PPTX](git-merge.pptx)和 [126.27 秒英文配音视频](git-merge.mp4)分别呈现同一问题；另附[字幕](git-merge.mp4.srt)与[研究报告](research/report.md)。
...
[四种作者源](projects/)随附。PPTX 使用迭代后技能，见 [PPTX 收录记录](../pptx-publication.json)和[当前项目 QA](projects/pptx/qa/)；其他格式使用[原验收记录](../../evals/examples/refresh-20260916/git-merge/)，不把旧幻灯片观察算作新 PPT 的检查。试片已由用户听看确认，完整视频听看仍未确认。复现与完整边界见[统一说明](../README.md)。
